...
from ..plan_rbfe_radial_network import run_inputs as main
from ..plan_rbfe_radial_network import get_settings_charge_changes
            ...
            with pytest.warns(UserWarning, match='Charge changing transformation'):
                result = runner.invoke(
                    ...
                    ['--ligands', ligands, '--pdb', protein,
                     '--cofactors', cofactors, '--central_ligand_num', 1,
                     '--output', output]
                )
